...
bool initGame()
{
	...
	backgroundTexture[0].loadFromFile(RESOURCES_PATH "spaceBackground.png", true);
	backgroundTexture[1].loadFromFile(RESOURCES_PATH "nebulae.png", true);
	backgroundTexture[2].loadFromFile(RESOURCES_PATH "stars.png", true);
	backgroundTexture[3].loadFromFile(RESOURCES_PATH "planets.png", true);
	...
	tiledRenderer[1].parallaxStrength = 0.2;
	tiledRenderer[2].parallaxStrength = 0.5;
	tiledRenderer[3].parallaxStrength = 0.7;
	return true;
}
...
#pragma region render background
	...
	renderer.currentCamera.zoom = 0.4;
